...
processing in the command line options; for example, this might be --input,
--fastq or the position in the input arguments. The output BAM file, a standard
format for sequence alignment, generated by a short read aligner may be created
...
python's pip and Docker be installed. General instructions for installing pip
are widely available online. Instructions for installing Docker can be found on
the Docker website \[5\].
